...
async def TranlateAndExecute(commands: list[str]):
...
async def Automation(commands: list[str]):
    ...
    async for result in TranlateAndExecute(commands):
        pass

    return True

if __name__ == "__main__":
    asyncio.run(Automation(["open facebook", "open intagram", "open whatsappweb"]))
